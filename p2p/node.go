...
func NewNode(cfg *types.CalorieConfig) (*Node, error) {
...
func (n *Node) detectNodeAddr() {
	...
	for {
		...
		n.nodeInfo.blacklist.Add(externaladdr, 0) 		if exaddr, err := NewNetAddressString(externaladdr); err == nil {
			n.nodeInfo.SetExternalAddr(exaddr)
			n.nodeInfo.addrBook.AddOurAddress(exaddr)
...
func (n *Node) natMapPort() {
	...
	err = n.nodeInfo.addrBook.bookDb.Set([]byte(externalPortTag),
		P2pComm.Int32ToBytes(int32(n.nodeInfo.GetExternalAddr().Port))) 
	if err != nil {
